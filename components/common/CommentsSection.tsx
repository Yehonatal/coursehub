...
function CommentItem({
    ...
    return (
        <div className={cn("flex gap-4", depth > 0 && "ml-12 mt-6")}>
            <div className="w-10 h-10 rounded-xl bg-muted shrink-0 overflow-hidden border border-border/40">
            ...
            <div className="space-y-2 flex-1">
                ...
                <div className="flex items-center gap-4 text-[11px] font-bold uppercase tracking-wider text-muted-foreground/60 pt-1">
                    <button
                ...
                {comment.replies?.length ? (
                    <div className="space-y-6 mt-6 border-l-2 border-muted/30 pl-6">
...
export function CommentsSection({
    ...
    return (
        <div className={cn("space-y-10", className)}>
            <div className="bg-muted/30 p-8 rounded-[2rem] border border-border/40 space-y-4 relative overflow-hidden group">
                ...
                <textarea
                    ...
                    className="w-full bg-transparent border-none resize-none focus:ring-0 p-0 text-primary placeholder:text-muted-foreground/50 min-h-12 text-sm relative z-10"
                    rows={3}
                    value={value}
