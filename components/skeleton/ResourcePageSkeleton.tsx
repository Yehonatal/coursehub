    ...
    return (
        <div className="w-full border-b border-border/40">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pb-6">
                <div className="h-24 sm:h-48 w-full rounded-3xl bg-muted animate-pulse" />
            </div>
        </div>
    );
}
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-4">
                ...
                <div className="hidden md:flex items-center gap-2.5 p-2 rounded-xl bg-muted/30 border border-border/40 w-48">
                    ...
                    <div className="space-y-1 flex-1">
                        <div className="h-3 w-full bg-muted rounded-xl"></div>
                        <div className="h-2 w-2/3 bg-muted rounded-xl"></div>
                    </div>
                </div>
            </div>
        ...
        <div className="space-y-10 animate-pulse">
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                    <div className="h-4 w-full bg-muted/60 rounded-xl"></div>
                    <div className="h-4 w-full bg-muted/60 rounded-xl"></div>
                    <div className="h-4 w-4/5 bg-muted/60 rounded-xl"></div>
                </div>
            </div>
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[1, 2, 3, 4].map((i) => (
                        <div
                            key={i}
                            className="h-16 bg-muted rounded-3xl"
                        ></div>
                    ))}
                </div>
            </div>
        ...
        <div className="space-y-8 animate-pulse">
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div className="h-7 w-32 bg-muted rounded-xl"></div>
                    <div className="h-4 w-16 bg-muted rounded-xl"></div>
                </div>
                <div className="space-y-4">
                    {[1, 2, 3].map((i) => (
                        <div
            ...
            <div className="space-y-4">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="flex gap-4">
                        <div className="w-20 h-20 bg-muted rounded-xl shrink-0"></div>
                        <div className="space-y-2 flex-1">
                            <div className="h-4 w-3/4 bg-muted rounded-xl"></div>
                            <div className="h-3 w-1/2 bg-muted rounded-xl"></div>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="space-y-6">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="flex gap-4">
                        ...
                        <div className="space-y-2 flex-1">
                            <div className="h-4 w-32 bg-muted rounded-xl"></div>
                            <div className="h-4 w-full bg-muted rounded-xl"></div>
                            <div className="h-4 w-2/3 bg-muted rounded-xl"></div>
                        </div>
                    </div>
                ))}
            </div>
        ...
        <div className="space-y-12 animate-pulse">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-2">
                    <div className="h-8 w-48 bg-muted rounded-xl"></div>
                    <div className="h-4 w-64 bg-muted/60 rounded-xl"></div>
                </div>
            </div>
