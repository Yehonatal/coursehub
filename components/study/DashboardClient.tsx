            ...
            <div className="flex-1 flex flex-col items-center pt-20 px-8 max-w-7xl mx-auto w-full space-y-8">
                    ...
                    {recentResources.length > 0 ? (
                        recentResources.slice(0, 3).map((resource) => (
                            <Link
                                ...
                                className="p-4 bg-card border border-border/50 rounded-xl hover:border-primary/20 hover:shadow-sm transition-all cursor-pointer group flex items-start gap-4 block"
                            >
                                ...
                                <div className="overflow-hidden">
                                    <h4 className="font-medium text-sm line-clamp-1 group-hover:text-primary transition-colors truncate">
                                        {resource.title}
                                    </h4>
                        ...
                        <div className="col-span-1 md:col-span-3 text-center text-muted-foreground p-4 text-sm">
                            No recent resources found. Upload one to get
                            started!
                        </div>
                    )}
                </div>
                ...
                <div className="w-full max-w-5xl space-y-4 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300 pb-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        <Link href="/study/classes/test-class-1">
