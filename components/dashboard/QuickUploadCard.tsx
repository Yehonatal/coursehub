...
export function QuickUploadCard() {
    return (
        <div className="space-y-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <Card className="p-8 border-dashed border-2 border-border/60 bg-muted/30 flex flex-col items-center justify-center text-center gap-4 hover:bg-muted/50 transition-colors cursor-pointer group">
