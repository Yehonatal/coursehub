        ...
        <div data-aos="fade-up" data-aos-delay="300" suppressHydrationWarning>
            ...
            >
                {resources.map((item, i) => (
                    ...
                    >
                        <Card className="p-4 space-y-4 hover:shadow-sm transition-all duration-300 border-border/60 rounded-xl hover:-translate-y-1 h-full">
                            ...
                            <div className="space-y-2">
                                <h4 className="font-bold text-[#0A251D] leading-tight line-clamp-2 group-hover:text-blue-600 transition-colors">
                                    {item.title}
                                </h4>
